...
```{r}
ggplot() +
  geom_point(data = QC, aes(x = DIC, y = TALK, shape = "historical data", col = "historical data")) +
  geom_point(data = may, aes(x = DIC, y = TA, shape = "May 2021 cruise", col = "May 2021 cruise")) +
  geom_point(data = oct, aes(x = DIC, y = TA, shape = "Oct 2021 cruise", col = "Oct 2021 cruise")) +
  scale_shape_manual(values = c(1, 2, 3), name = "Data Source") +
  scale_colour_manual(values = c("black", "chartreuse3", "deepskyblue3"), name = "Data Source") +
