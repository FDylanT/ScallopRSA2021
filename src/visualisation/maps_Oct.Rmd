...
Run chunks 1-5? of `chemistry_Oct.Rmd` to load data.
...
## Load GB shapefiles
```{r}
GB <- st_read("./data/SAM-zones/GB_Estimation_Areas_2019_UTM19_PDT_SFModified.shp")
...
DO <- ggplot() +
  ...
  geom_contour(data = bathy_xyz,
               ...
               breaks = -500, alpha = 0.3, colour = "grey50") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(limits = c(200, 337),
...
plot_grid(
  ...
  plot_grid(
    ...
    ncol = 3, nrow = 4,
    align = "hv",
    labels = c("a (May, surface)", "", "", "b (May, bottom)", "", "",
               "c (Oct, surface)", "", "", "d (Oct, bottom)", "", ""),
    label_size = 10,
    hjust = -0.17,
    vjust = 2.5),
  nrow = 2,
...
ggsave("Fig2.png", width = 6.5, height = 7.3, units = "in", dpi = 600, bg = "#ffffff")
```
...
omega <- ggplot() +
  ...
  scale_fill_viridis(limits = c(1.3, 3.11), option = "inferno",
                       aesthetics = c("fill", "colour"),
                       name = expression(bold(Ω[Ar]))) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(-70.5, -66), ylim = c(40, 42.5), crs = st_crs(4326)) +
  labs(title = expression(bold(Ω[Ar]))) +
  guides(fill = guide_colourbar(title.position = "top", title.hjust = 0.5),
         col = guide_colourbar(title.position = "top", title.hjust = 0.5)) +
  theme_bw() +
  theme(axis.title = element_blank(),
...
ggsave("Fig3.png", width = 6.5, height = 7.3, units = "in", dpi = 600, bg = "#ffffff")
```
...
ggsave("Fig4.png", width = 4.425, height = 4.1, units = "in", dpi = 600, bg = "#ffffff")
```
...
May.TvS <- ggplot() +
  ...
  labs(title = "May") +
  theme_bw() +
  theme(plot.title = element_text(face = "bold.italic", hjust = 0.55, size = 10),
...
s <- ggplot() +
  ylab("Surface") +
  theme(axis.title = element_text(face = "bold.italic", size = 10, hjust = 0.55))
...
plot_grid(
  ...
  plot_grid(
    ...
    ncol = 2, nrow = 1),
  plot_grid(
    get_plot_component(s, "ylab-l"),
    get_plot_component(b, "ylab-l"),
    nrow = 2
  ),
  plot_grid(
...
ggsave("Fig5.png", width = 6.5, height = 5.1, units = "in", dpi = 600, bg = "#ffffff")
```
...
May.DICvS <- ggplot() +
  ...
  theme(plot.title = element_text(face = "bold.italic", hjust = 0.55, size = 10),
        ...
        legend.margin = margin(t = 4, r = 10, b = 6, l = 4))
...
Oct.DICvS <- ggplot() +
  ...
  labs(title = "October") +
  theme_bw() +
  theme(plot.title = element_text(face = "bold.italic", hjust = 0.6, size = 10),
        axis.title = element_text(size = 10),
        legend.position = "none")
...
plot_grid(
  plot_grid(
    ...
    ncol = 2, nrow = 1),
  plot_grid(
    May.DICvS + theme(plot.title = element_blank()),
    ...
    labels = c("a", "b", "c", "d"),
    label_size = 10,
    hjust = c(-9.5, -8.65, -9.5, -8.65),
    vjust = 2.5),
  nrow = 2,
  rel_heights = c(1, 20)
)

ggsave("Fig6.png", width = 6.5, height = 5.1, units = "in", dpi = 600, bg = "#ffffff")
```
...
deltaTA.DIC <- ggplot() +
  ...
  theme(plot.title = element_text(face = "bold.italic", hjust = 0.55, size = 10),
        ...
        legend.key.height = unit(0.15, "in"),
        legend.key.width = unit(0.15, "in"),
        legend.margin = margin(t = 4, r = 4, b = 2.5, l = 4))
...
plot_grid(
  plot_grid(
    ...
    nrow = 1),
  plot_grid(
    deltaTA.DIC + theme(plot.title = element_blank()),
    ...
    label_size = 10,
    hjust = c(-8.25, -7.5, -8.25, -7.5, -8.25, -13.75),
    vjust = 2.5),
  nrow = 2,
  rel_heights = c(1, 30)
)
...
DICf <- ggplot() +
  ...
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       ...
                       aesthetics = c("fill", "colour"),
                       name = expression(bold(ΔDIC[air-sea]))) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(-70.5, -66), ylim = c(40, 42.5), crs = st_crs(4326)) +
  #labs(title = "Surface DIC_flux [Oct]") +
  guides(fill = guide_colourbar(title.position = "top", title.hjust = 0.5),
...
plot_grid(
  ...
  plot_grid(
    plot_grid(
      ...
      plot_grid(
        odDIC + theme(plot.title = element_blank(), legend.position = "none"),
        odDIC2 + theme(plot.title = element_blank(), legend.position = "none"),
        ncol = 2,
        align = "hv",
        labels = c("a", ""),
        label_size = 10,
    ...
    plot_grid(
      ...
      plot_grid(
        odTA + theme(plot.title = element_blank(), legend.position = "none"),
        odTA2 + theme(plot.title = element_blank(), legend.position = "none"),
        ncol = 2),
      plot_grid(
        get_legend(oTApr)
      ),
      plot_grid(
        oTApr + theme(legend.position = "none"),
        oTApr2 + theme(legend.position = "none"),
        ncol = 2
      ),
      plot_grid(
        get_legend(oTApr + theme(legend.position = "none"))
      ),
      plot_grid(
        ggplot(),
        ggplot(),
      ...
      plot_grid(
        oTAo + theme(legend.position = "none"),
        oTAo2 + theme(legend.position = "none"),
        ncol = 2,
        align = "hv"),
      nrow = 8,
      rel_heights = c(1, 6, 1, 6, 1, 6, 1, 6)
...
deltaTA.DICo2 <- deltaTA.DICo + labs(title = "October")

ex1 + inset_element(deltaTA.DICo2, left = 0.005, bottom = 0.5, right = 0.45, top = 0.995)

ggsave("Fig10.png", width = 6.5, height = 4.6, units = "in", dpi = 600, bg = "#ffffff")
```

## 8-panel future projections figure
```{r}
# May
omega50 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = omega_fut2050), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = omega_fut2050), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
  ...
  geom_contour(data = bathy_xyz,
               ...
               breaks = -500, alpha = 0.3, colour = "grey50") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = brewer.spectral(100), limits = c(0.68, 2.06),
                       aesthetics = c("fill", "colour"),
                       name = expression(bold(Ω[Ar]))) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(-70.5, -66), ylim = c(40, 42.5), crs = st_crs(4326)) +
...
omega100 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = omega_fut), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = omega_fut), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
delta50 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = -(OmegaAragonite - omega_fut2050)), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = -(OmegaAragonite - omega_fut2050)), size = 2.25, shape = 23,
          linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
  ...
  geom_contour(data = bathy_xyz,
               ...
               breaks = -500, alpha = 0.3, colour = "grey50") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = brewer.spectral(100), limits = c(-1, -0.3),
                       aesthetics = c("fill", "colour"),
                       name = expression(bold(ΔΩ[Ar]))) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(-70.5, -66), ylim = c(40, 42.5), crs = st_crs(4326)) +
  guides(fill = guide_colourbar(title.position = "top", title.hjust = 0.5),
         col = guide_colourbar(title.position = "top", title.hjust = 0.5)) +
...
delta100 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = -(OmegaAragonite - omega_fut)), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = -(OmegaAragonite - omega_fut)), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
# October
omega50.o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = omega_fut2050), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = omega_fut2050), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
omega100.o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = omega_fut), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = omega_fut), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
delta50.o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = -(OmegaAragonite - omega_fut2050)), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = -(OmegaAragonite - omega_fut2050)), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
delta100.o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = -(OmegaAragonite - omega_fut)), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = -(OmegaAragonite - omega_fut)), size = 2.25, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
plot_grid(
  ...
  plot_grid(
    ...
    plot_grid(
      omega50 + theme(plot.title = element_blank(), legend.position = "none"),
      omega50.o + theme(plot.title = element_blank(), legend.position = "none"),
      ncol = 2,
      align = "hv",
      labels = c("a (2050)", ""),
      label_size = 10,
    ...
    plot_grid(
      delta50 + theme(legend.position = "none"),
      delta50.o,
      ncol = 2,
      align = "hv",
      labels = c("b (2050–present)", ""),
      label_size = 10,
      hjust = -0.15,
      vjust = 2.75
    ),
...
ggsave("Fig11.png", width = 3.8, height = 7.3, units = "in", dpi = 600, bg = "#ffffff")
```

## Supplement

Supp 1 & 2 in separate script; Supp 3 is MATLAB
...
dDOb <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = dDO), shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
dDO2b <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = dDO), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = dDO), shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
plot_grid(
  ...
  plot_grid(
    ...
    plot_grid(
      dDOb + theme(plot.title = element_blank(), legend.position = "none"),
      dDO2b + theme(plot.title = element_blank(), legend.position = "none"),
      ncol = 2,
      align = "hv",
      labels = c("b (bottom)", ""),
      label_size = 10,
    ...
    nrow = 6,
    rel_heights = c(1, 6, 1, 6, 1, 6)
  ),
  nrow = 2,
  rel_heights = c(1, 18)
)

ggsave("SuppFig5.png", width = 3.6, height = 5.6, units = "in", dpi = 600, bg = "#ffffff")
```
