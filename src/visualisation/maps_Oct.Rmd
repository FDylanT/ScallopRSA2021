...
```{r}
May.TvS <- ggplot() +
  geom_point(data = may[may$Cast == "Surface", ], aes(x = Salinity, y = Temp, shape = Cast), shape = 1) +
  # EM1
  annotate("point", x = 33.02325, y = 7.220628, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 33.02325, xend = 33.02325, y = 7.220628-0.069308, yend = 7.220628+0.069308,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.30807, y = 8.128582, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.30807, xend = 32.30807, y = 8.128582-0.05763103, yend = 8.128582+0.05763103,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 32.8277, y = 8.868272, size = 4, col = "firebrick3") +
...
Oct.TvS <- ggplot() +
  geom_point(data = oct[oct$Cast == "Surface", ],
             aes(x = Salinity, y = Temp, shape = Cast), shape = 1) +
  # EM1
  annotate("point", x = 32.36303, y = 17.61663, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.36303, xend = 32.36303, y = 17.61663-0.1872035, yend = 17.61663+0.1872035,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.6138, y = 16.38836, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.6138, xend = 32.6138, y = 16.38836-0.1211196, yend = 16.38836+0.1211196,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 34.03515, y = 20.41137, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 34.03515, xend = 34.03515, y = 20.41137-0.4061293, yend = 20.41137+0.4061293,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 31.63787, y = 16.75489, size = 4, col = "firebrick3") +
...
May.TvS.2 <- ggplot() +
  geom_point(data = may[may$Cast == "Bottom", ],
             aes(x = Salinity, y = Temp, shape = Cast), shape = 1) +
  # EM4
  annotate("point", x = 32.60722, y = 6.913535, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.60722, xend = 32.60722, y = 6.913535-0.06965717, yend = 6.913535+0.06965717,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.92325, y = 8.043115, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.92325, xend = 32.92325, y = 8.043115-0.1243565, yend = 8.043115+0.1243565,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 32.9749, y = 6.843245, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.9749, xend = 32.9749, y = 6.843245-0.04853802, yend = 6.843245+0.04853802,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 34.3181, y = 9.877368, size = 4, col = "firebrick3") +
...
Oct.TvS.2 <- ggplot() +
  geom_point(data = oct[oct$Cast == "Bottom", ],
             aes(x = Salinity, y = Temp, shape = Cast), shape = 1) +
  # EM4
  annotate("point", x = 32.5582, y = 18.31397, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.5582, xend = 32.5582, y = 18.31397-0.1474015, yend = 18.31397+0.1474015,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.98455, y = 8.538995, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.98455, xend = 32.98455, y = 8.538995-0.3136846, yend = 8.538995+0.3136846,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 35.49357, y = 15.75253, size = 4, col = "firebrick3") +
...
legend.only <- ggplot() +
  ...
  geom_point(data = may, aes(x = Salinity, y = Temp, col = "Endmember"), size = 3) +
...
May.DICvS <- ggplot() +
  geom_point(data = may,
             aes(x = Salinity, y = DIC, shape = Cast)) +
  scale_shape_manual(values = c(1, 16),
                     breaks = c("Surface", "Bottom"),
                     guide = guide_legend(reverse = TRUE)) +
  # EM1
  annotate("point", x = 33.02325, y = 2076.15, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 33.02325, xend = 33.02325, y = 2076.15-6.64003, yend = 2076.15+6.64003,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.30807, y = 2031.767, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.30807, xend = 32.30807, y = 2031.767-2.814842, yend = 2031.767+2.814842,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 32.8277, y = 2030.25, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.8277, xend = 32.8277, y = 2030.25-1.626346, yend = 2030.25+1.626346,
           col = "firebrick3") +
  # EM4
  annotate("point", x = 32.60722, y = 2066.45, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.60722, xend = 32.60722, y = 2066.45-8.914969, yend = 2066.45+8.914969,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.92325, y = 2061.15, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.92325, xend = 32.92325, y = 2061.15-5.586144, yend = 2061.15+5.586144,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 32.9749, y = 2098.8, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.9749, xend = 32.9749, y = 2098.8-4.521062, yend = 2098.8+4.521062,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 34.3181, y = 2133.85, size = 4, col = "firebrick3") +
...
Oct.DICvS <- ggplot() +
  ...
  scale_shape_manual(values = c(1, 16),
                     ...
                     guide = guide_legend(reverse = TRUE)) +
  # EM1
  annotate("point", x = 32.36303, y = 1971.917, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.36303, xend = 32.36303, y = 1971.917-12.34689, yend = 1971.917+12.34689,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.6138, y = 2018.4, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.6138, xend = 32.6138, y = 2018.4-3.668787, yend = 2018.4+3.668787,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 34.03515, y = 2006.35, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 34.03515, xend = 34.03515, y = 2006.35-9.828784, yend = 2006.35+9.828784,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 31.63787, y = 1941.6, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 31.63787, xend = 31.63787, y = 1941.6-8.669487, yend = 1941.6+8.669487,
           col = "firebrick3") +
  # EM4
  annotate("point", x = 32.5582, y = 1997.6, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.5582, xend = 32.5582, y = 1997.6-6.788225, yend = 1997.6+6.788225,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.98455, y = 2119.45, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.98455, xend = 32.98455, y = 2119.45-0.6363961, yend = 2119.45+0.6363961,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 35.49357, y = 2147.333, size = 4, col = "firebrick3") +
...
May.TAvS <- ggplot() +
  geom_point(data = may,
             aes(x = Salinity, y = TA, shape = Cast)) +
  scale_shape_manual(values = c(1, 16),
                     breaks = c("Surface", "Bottom"),
                     guide = guide_legend(reverse = TRUE)) +
  # EM1
  annotate("point", x = 33.02325, y = 2227.4, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 33.02325, xend = 33.02325, y = 2227.4-2.255364, yend = 2227.4+2.255364,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.30807, y = 2203.833, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.30807, xend = 32.30807, y = 2203.833-2.411086, yend = 2203.833+2.411086,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 32.8277, y = 2204.9, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.8277, xend = 32.8277, y = 2204.9-9.616652, yend = 2204.9+9.616652,
           col = "firebrick3") +
  # EM4
  annotate("point", x = 32.60722, y = 2215.65, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.60722, xend = 32.60722, y = 2215.65-3.51141, yend = 2215.65+3.51141,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.92325, y = 2222.95, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.92325, xend = 32.92325, y = 2222.95-10.67731, yend = 2222.95+10.67731,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 32.9749, y = 2227.233, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.9749, xend = 32.9749, y = 2227.233-1.625833, yend = 2227.233+1.625833,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 34.3181, y = 2289.1, size = 4, col = "firebrick3") +
...
Oct.TAvS <- ggplot() +
  ...
  scale_shape_manual(values = c(1, 16),
                     ...
                     guide = guide_legend(reverse = TRUE)) +
  # EM1
  annotate("point", x = 32.36303, y = 2185.983, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.36303, xend = 32.36303, y = 2185.983-2.585666, yend = 2185.983+2.585666,
           col = "firebrick3") +
  # EM2
  annotate("point", x = 32.6138, y = 2199.65, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 32.6138, xend = 32.6138, y = 2199.65-5.679495, yend = 2199.65+5.679495,
           col = "firebrick3") +
  # EM3
  annotate("point", x = 34.03515, y = 2279.6, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 34.03515, xend = 34.03515, y = 2279.6-2.12132, yend = 2279.6+2.12132,
           col = "firebrick3") +
  # EM7
  annotate("point", x = 31.63787, y = 2162.1, size = 3, col = "firebrick3", shape = 1, stroke = 1.5) +
  ...
  annotate("segment", x = 31.63787, xend = 31.63787, y = 2162.1-11.9662, yend = 2162.1+11.9662,
           col = "firebrick3") +
  # EM4
  annotate("point", x = 32.5582, y = 2181.3, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.5582, xend = 32.5582, y = 2181.3-0.1414214, yend = 2181.3+0.1414214,
           col = "firebrick3") +
  # EM5
  annotate("point", x = 32.98455, y = 2227.9, size = 4, col = "firebrick3") +
  ...
  annotate("segment", x = 32.98455, xend = 32.98455, y = 2227.9-0.8485281, yend = 2227.9+0.8485281,
           col = "firebrick3") +
  # EM6
  annotate("point", x = 35.49357, y = 2349.533, size = 4, col = "firebrick3") +
...
legend.only <- ggplot() +
  geom_point(data = may, aes(x = Salinity, y = Temp, shape = Cast, col = "Measured")) +
  geom_point(data = oct, aes(x = Salinity, y = Temp, shape = Cast, col = "Endmember"), size = 3) +
  scale_colour_manual(values = c("black", "firebrick3"),
                      breaks = c("Measured", "Endmember"),
                      name = "Value") +
  scale_shape_manual(values = c(1, 16),
                     breaks = c("Surface", "Bottom"),
                     name = "Layer") +
  guides(col = guide_legend(title.position = "top", override.aes = list(shape = c(1, 1), size = c(1.5, 3))),
         shape = guide_legend(override.aes = list(shape = c(1, 16), size = c(1.5, 1.5)))) +
  theme_bw() +
  theme(legend.title = element_text(face = "bold"),
        legend.position = "left")
...
DIC <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = DIC), size = 4, shape = 23, linetype = "dashed") +
...
TA <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = TA), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DO <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = DO), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DIC2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = DIC), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TA2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = TA), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DO2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = DO), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DICo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = DIC), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = DIC), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TAo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = TA), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = TA), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DOo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = DO), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = DO), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DIC2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = DIC), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = DIC), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TA2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = TA), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = TA), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
DO2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = DO), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = DO), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
pH <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = pH), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
omega <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = OmegaAragonite), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
AOU <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = AOU), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
pH2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = pH), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
omega2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = OmegaAragonite), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
AOU2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = AOU), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
pHo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = pH), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = pH), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
omega.o <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = OmegaAragonite), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = OmegaAragonite), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
AOUo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = AOU), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = AOU), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
pH2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = pH), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = pH), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
omega2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = OmegaAragonite), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = OmegaAragonite), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
AOU2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = AOU), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = AOU), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
may_pCO2 <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = pCO2), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
may_flux <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = flux / 10^3), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oct_pCO2 <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = pCO2), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = pCO2), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oct_flux <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = flux / 10^3), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = flux / 10^3), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
```{r}
deltaTA.DIC <- ggplot() +
  geom_point(data = may, aes(x = dDIC, y = dTA, col = Cast), shape = 1) +
...
deltaDO.TA <- ggplot() +
  geom_point(data = may, aes(x = dTA, y = dDO, col = Cast), shape = 1) +
  annotate("rect", alpha = 0.2, fill = "grey50",
...
deltaTA.DICo <- ggplot() +
  geom_point(data = oct, aes(x = dDIC, y = dTA, col = Cast), shape = 1) +
  annotate("rect", alpha = 0.2, fill = "grey50",
...
deltaDO.DICo <- ggplot() +
  geom_point(data = oct, aes(x = dDIC, y = dDO, col = Cast), shape = 1) +
  annotate("rect", alpha = 0.2, fill = "grey50",
           xmin = -median(oct$sdDICn, na.rm = TRUE),
           xmax = median(oct$sdDICn, na.rm = TRUE),
           ymin = -Inf,
...
deltaDO.TAo <- ggplot() +
  geom_point(data = oct, aes(x = dTA, y = dDO, col = Cast), shape = 1) +
  annotate("rect", alpha = 0.2, fill = "grey50",
...
dDIC <- ggplot() +
  ...
  geom_sf(data = surface_sf_v2[surface_sf_v2$Station == "009", ],
          fill = "grey8",
          size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = dDIC), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICpr <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = DICpr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICf <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = DICf), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = DIC.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = DIC.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
dDIC2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_v2[bottom_sf_v2$Station == "009", ],
          fill = "grey8",
          size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = dDIC), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICpr2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = DICpr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICf2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = DICf), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
oDICo2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_v2[bottom_sf_v2$Station == "009", ],
          fill = "grey8",
          size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = DIC.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
dTA <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = dTA), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TApr <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = TApr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TAo <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = TA.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
dTA2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = dTA), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TApr2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = TApr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
TAo2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = TA.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
T <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = Temp), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
S <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = Salinity), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
T2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = Temp), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
S2 <- ggplot() +
  ...
  geom_sf(data = bottom_sf_m3, aes(fill = Salinity), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
To <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = Temp), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = Temp), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
So <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = Salinity), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = Salinity), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
T2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = Temp), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = Temp), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
S2o <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = Salinity), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(fill = Salinity), size = 4, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_contour(data = bathy_xyz,
               aes(x = V1, y = V2, z = V3),
               breaks = -50, alpha = 0.3, colour = "grey50") +
...
dDO <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = dDO), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = dDO), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
O2.flux <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = flux.O2/10^3), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf3, aes(fill = flux.O2/10^3), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-137, 137),
...
dDO2 <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = dDO), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-26.72, 26.72),
...
O2.flux2 <- ggplot() +
  ...
  geom_sf(data = surface_sf_m3, aes(fill = flux.O2/10^3), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-137, 137),
