...
```{r}
# dDIC
  #min(bottom_sf2$dDIC) # -70.65599 - outlier
sort(bottom_sf2$dDIC)[2] # -39.07236
min(surface_sf2$dDIC) # -32.52417
  #max(bottom_sf2$dDIC) # 54.72723
sort(bottom_sf2$dDIC, decreasing = TRUE)[2] # 31.56417
max(surface_sf2$dDIC) # 48.51614
...
# dDO
min(bottom_sf2$dDO) # -30.09748
min(surface_sf2$dDO) # -19.17679
max(bottom_sf2$dDO) # 3.359133
max(surface_sf2$dDO) # 13.80157
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-71, 71), palette = "RdBu",
                       breaks = c(-70, 0, 70),
                       aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-31, 31), palette = "RdBu",
                       aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
```{r}
# dTA
min(bottom_sf2$dTA) # -11.97313
min(surface_sf2$dTA) # -18.53638
  #max(bottom_sf2$dTA) # 53.22597 - outlier
sort(bottom_sf2$dTA, decreasing = TRUE)[2] # 28.65683
  #max(surface_sf2$dTA) # 33.22491
sort(surface_sf2$dTA, decreasing = TRUE)[2] # 28.05411
...
DIC <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1930, 2155), option = "mako", direction = -1,
                     aesthetics = c("fill", "colour"),
                     name = "DIC (umol/kg)") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
TA <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(2140, 2355), option = "rocket", direction = -1,
                     aesthetics = c("fill", "colour"),
                     name = "TA (umol/kg)  ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
DO <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(200, 330), palette = "PuBuGn",
                       direction = "trans",
                       aesthetics = c("fill", "colour"),
                     name = "DO (umol/kg) ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
...
DIC2 <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1930, 2155), option = "mako",
                     direction = -1,
                     aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
plot_grid(
  ...
  plot_grid(
    ...
    scale = 1),
  plot_grid(
    T + theme(legend.position = "none", plot.title = element_blank()),
    T2 + theme(plot.title = element_blank()),
...
### 8-panel derived parameter maps
```{r}
pH <- ggplot() +
  geom_sf(data = surface_sf_v2, aes(fill = pH), size = 0.25, colour = NA) +
...
omega <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(1.3, 3.11), palette = "YlGn",
                       aesthetics = c("fill", "colour"),
                       name = "Omega\nAragonite        ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
pCO2.2 <- ggplot() +
  geom_sf(data = bottom_sf_v2, aes(fill = pCO2), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf3, aes(col = pCO2), size = 6, shape = 18) +
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(179, 661),
                       palette = "PRGn",
                       aesthetics = c("fill", "colour"),
...
plot_grid(
  ...
  plot_grid(
    ...
    scale = 1),
  plot_grid(
    pH + theme(legend.position = "none", plot.title = element_blank()),
    pH2 + theme(plot.title = element_blank()),
    pCO2 + theme(legend.position = "none"),
    pCO2.2,
    omega + theme(legend.position = "none"),
    omega2,
...
plot_grid(
  plot_grid(
    may_flux,
    oct_flux + theme(legend.position = "none"),
    ncol = 2,
    align = "hv",
    labels = c("A", "B")),
  plot_grid(
...
deltaDO.DIC <- ggplot() +
  ...
  geom_vline(xintercept = 0, linetype = 2) +
  geom_hline(yintercept = 0, linetype = 2) +
  geom_abline(intercept = 0, slope = -138/106) +
  scale_shape_manual(values = c(16, 1),
                     guide = guide_legend(reverse = TRUE)) +
  scale_colour_manual(values = c("chartreuse3", "royalblue"),
                      name = "Month") +
...
deltaTA.DO <- ggplot() +
  ...
  geom_vline(xintercept = 0, linetype = 2) +
  geom_hline(yintercept = 0, linetype = 2) +
  geom_abline(intercept = 0, slope = 17/138) +
  scale_shape_manual(values = c(16, 1),
                     guide = guide_legend(reverse = TRUE)) +
  scale_colour_manual(values = c("chartreuse3", "royalblue"),
                      name = "Month") +
...
plot_grid(
  plot_grid(
    deltaTA.DIC,
    deltaDO.DIC + theme(legend.position = "none"),
    deltaTA.DO,
    ncol = 2, nrow = 2,
    align = "hv",
    labels = c("A", "B", "C")),
  plot_grid(
    get_legend(deltaDO.DIC),
    ncol = 1,
    scale = 1),
  rel_widths = c(8, 1)
)
...
dDIC <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-49, 49), palette = "RdBu",
                       breaks = c(-48, -25, 0, 25, 48),
                       aesthetics = c("fill", "colour"),
                       name = "delta DIC") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
dTA <- ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-29, 29), palette = "RdBu",
                       breaks = c(-28, -15, 0, 15, 28),
                       aesthetics = c("fill", "colour"),
                       name = "delta TA  ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
