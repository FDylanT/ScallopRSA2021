...
min(surface_sf2$dDIC) # -37.75006
max(bottom_sf2$dDIC) # 54.72723
max(surface_sf2$dDIC) # 34.52836
...
# DICf
min(surface_sf2$DICf, na.rm = T) # -36.45915
max(surface_sf2$DICf, na.rm = T) # 44.46224

# dDO
min(bottom_sf2$dDO) # -30.86959
min(surface_sf2$dDO) # -25.66901
max(bottom_sf2$dDO) # 3.448162
max(surface_sf2$dDO) # 23.41103

# DICpr
min(bottom_sf2$DICpr) # -2.648588
min(surface_sf2$DICpr) # -17.98238
max(bottom_sf2$DICpr) # 23.71143
max(surface_sf2$DICpr) # 19.71677

# DIC.other
  #min(bottom_sf2$DIC.other) # -21.46247 - outlier
sort(bottom_sf2$DIC.other)[2] # -42.52389
min(surface_sf2$DIC.other) # -56.62939
max(bottom_sf2$DIC.other) # 47.86287
max(surface_sf2$DIC.other) # 57.52985
```
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-100, 100), palette = "BrBG",
                       aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
mean(abs(oct$DIC.other[which(!(oct$Cast=="Surface" & (oct$Station=="001" |
                                                      oct$Station=="002" |
                                                      oct$Station=="003" |
                                                      oct$Station=="004" |
                                                      oct$Station=="005")))]))
...
min(surface_sf2$dTA) # -14.26346
  #max(bottom_sf2$dTA) # 53.52491 - outlier
