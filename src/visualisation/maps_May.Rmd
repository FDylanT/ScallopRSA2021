...
# OmegaCalcite
min(bottom_sf_m2$OmegaCalcite) # 2.292998
min(surface_sf_m2$OmegaCalcite) # 2.495019
max(bottom_sf_m2$OmegaCalcite) # 3.954682
max(surface_sf_m2$OmegaCalcite) # 3.553562
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(275, 435), palette = "BrBG",
                       aesthetics = c("fill", "colour"),
                       name = bquote(italic("p"~CO[2])),
                       breaks = c(290, 330, 370, 410)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
