...
dDIC <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = dDIC), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = dDIC), size = 2.5, shape = 23, linetype = "dashed") +
...
DICpr <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DICpr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
DICf <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DICf), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
DICo <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DIC.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DIC.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
dDIC2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = dDIC), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = dDIC), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-50.41, 50.41),
...
DICpr2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DICpr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-22.79, 22.79), #palette = "RdBu",
...
DICf2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DICf), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-1, 1),
...
DICo2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DIC.other), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DIC.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
dTA <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = dTA), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
TApr <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = TApr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
...
TAo <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = TA.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-40, 40),
...
dTA2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = dTA), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-35.65, 35.65),
...
TApr2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = TApr), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-3.66, 3.66),
...
TAo2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = TA.other), size = 2.5, shape = 23, linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-40, 40),
