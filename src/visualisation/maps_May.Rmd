...
dDIC <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = dDIC), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = dDIC), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
...
DICpr <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DICpr), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-21.7, 21.7), #palette = "RdBu",
                       aesthetics = c("fill", "colour"),
                       name = "Bio ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
DICf <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DICf), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-1, 1), #palette = "RdBu",
                       aesthetics = c("fill", "colour"),
                       name = "Flux") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
DICo <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = DIC.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = DIC.other), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-24.73, 24.73), #palette = "RdBu",
                       aesthetics = c("fill", "colour"),
                       name = "ε ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
dDIC2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = dDIC), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = dDIC), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-40.24, 40.24),
...
DICpr2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DICpr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DICpr), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-21.7, 21.7), #palette = "RdBu",
...
DICf2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DICf), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DICf), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-1, 1),
...
DICo2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = DIC.other), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = DIC.other), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-24.73, 24.73),
                       aesthetics = c("fill", "colour"),
                       name = "ε ") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
dTA <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = dTA), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-34.2, 34.2),
...
TApr <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = TApr), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-3.5, 3.5), #palette = "RdBu",
                       aesthetics = c("fill", "colour"),
                       name = "Bio") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
TAo <- ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(fill = TA.other), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-33.9, 33.9), #palette = "RdBu",
                       breaks = c(-30, -15, 0, 15, 30),
                       aesthetics = c("fill", "colour"),
                       name = "ε") +
  scale_y_continuous(breaks = c(40, 41, 42)) +
...
dTA2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = dTA), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = dTA), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-34.2, 34.2),
...
TApr2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = TApr), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = TApr), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-3.5, 3.5),
...
TAo2 <- ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = TA.other), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(fill = TA.other), size = 2.5, shape = 23, col = "black", linetype = "dashed") +
  geom_sf(data = GB_sf, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = mass, fill = "darkgrey", colour = NA) +
  scale_fill_gradientn(colours = diverging_hcl(100, "Blue-Red 3"),
                       limits = c(-33.9, 33.9),
