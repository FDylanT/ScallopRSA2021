...
```{r}
# DICn
min(bottom_sf_m2$DICn) # 2032.6
min(surface_sf_m2$DICn) # 2029.1
max(bottom_sf_m2$DICn) # 2137.4
max(surface_sf_m2$DICn) # 2067.593

# dDIC
min(bottom_sf_m2$dDIC) # -74.87484
min(surface_sf_m2$dDIC) # -39.65087
max(bottom_sf_m2$dDIC) # 32.64742
max(surface_sf_m2$dDIC) # 22.28002

# flux
min(bottom_sf_m2$flux, na.rm = T) # -14521.25
min(surface_sf_m2$flux)           # -18258.22
max(bottom_sf_m2$flux, na.rm = T) # 9931.482
max(surface_sf_m2$flux)           # 1637.761

# DICf
min(bottom_sf_m2$DICf, na.rm = T) # 
min(surface_sf_m2$DICf, na.rm = T) # -6.807474
max(bottom_sf_m2$DICf, na.rm = T) # 
max(surface_sf_m2$DICf, na.rm = T) # 83.41426

# DICpr
min(bottom_sf_m2$DICpr) # -17.65365
min(surface_sf_m2$DICpr) # -22.85987
max(bottom_sf_m2$DICpr) # 19.772
max(surface_sf_m2$DICpr) # 8.315552

# DIC.other
min(bottom_sf_m2$DIC.other) # -76.94278
min(surface_sf_m2$DIC.other) # -85.72161
max(bottom_sf_m2$DIC.other) # 32.82978
max(surface_sf_m2$DIC.other) # 23.36285
```
...
```{r}
# TAn
min(bottom_sf_m2$TAn) # 2195.2
min(surface_sf_m2$TAn) # 2198.1
max(bottom_sf_m2$TAn) # 2291.8
max(surface_sf_m2$TAn) # 2229.638
...
```{r}
ggplot() +
  geom_sf(data = bottom_sf_m_v2, aes(fill = TAn), size = 0.25, colour = NA) +
  geom_sf(data = bottom_sf_m3, aes(col = TAn), size = 8, shape = 18) +
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(2140, 2360), option = "mako", direction = -1,
                     aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
  labs(title = "Bottom TA_mixing [May]") +
  theme_bw()
...
```{r}
ggplot() +
  geom_sf(data = surface_sf_m_v2, aes(fill = TAn), size = 0.25, colour = NA) +
  geom_sf(data = surface_sf_m3, aes(col = TAn), size = 8, shape = 18) +
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(2140, 2360), option = "mako", direction = -1,
                     aesthetics = c("fill", "colour")) +
  scale_y_continuous(breaks = c(40, 41, 42)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
  labs(title = "Surface TA_mixing [May]") +
  theme_bw()
