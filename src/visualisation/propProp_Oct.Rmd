...
ggplot() +
  ...
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = -max(oct$sdDICn, na.rm = T),
           xmax = max(oct$sdDICn, na.rm = T),
           ymin = -Inf,
           ymax = Inf) +
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = -Inf,
           xmax = -max(oct$sdDICn, na.rm = T),
           ymin = -max(oct$sdTAn, na.rm = T),
           ymax = max(oct$sdTAn, na.rm = T)) +
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = max(oct$sdDICn, na.rm = T),
           xmax = Inf,
           ymin = -max(oct$sdTAn, na.rm = T),
...
ggplot() +
  ...
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = -Inf,
           xmax = -max(oct$sdDICn, na.rm = T),
           ymin = -max(oct$sdDOn, na.rm = T),
           ymax = max(oct$sdDOn, na.rm = T)) +
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = max(oct$sdDICn, na.rm = T),
           xmax = Inf,
           ymin = -max(oct$sdDOn, na.rm = T),
...
ggplot() +
  ...
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = -max(oct$sdTAn, na.rm = T),
           xmax = max(oct$sdTAn, na.rm = T),
           ymin = -Inf,
           ymax = Inf) +
  annotate("rect", alpha = 0.2, fill = "royalblue",
           xmin = -Inf,
