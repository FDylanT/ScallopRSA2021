...
Georges <-
  ...
  #geom_sf(data = NLS_West, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  #geom_sf(data = NLS_North, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  ##geom_sf(data = NLS_SouthShallow, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  #geom_sf(data = NLS_SouthDeep, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  ##geom_sf(data = GSC, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL1_Sliver, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL1_Access, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL1_South, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  ##geom_sf(data = NF, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL2_North, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL2_AccessSoutheast, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL2_AccessSouthwest, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  geom_sf(data = CL2_Ext, fill = "grey40", alpha = 0.4, colour = NA, linewidth = 0.4, linetype = "dashed") +
  #geom_sf(data = SF_East, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
  #geom_sf(data = SF, fill = NA, colour = "black", linewidth = 0.4, linetype = "dashed") +
