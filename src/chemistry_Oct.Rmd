...
EM7 <- which(oct$Station == "005" & oct$Cast == "Surface")
...
EMs6 <- sort(oct$Salinity[oct$Cast == "Bottom"], decreasing = TRUE)[1:3]
EMs6 <- c(which(oct$Salinity == EMs6[1]),
          which(oct$Salinity == EMs6[2]),
          which(oct$Salinity == EMs6[3]))
...
calc_area(source = source, mix = mix, discr = discr) # 479.2782
