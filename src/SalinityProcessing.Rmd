...
for (i in c(1:106)) {
  ...
  if (k == 4 | k == 5 | k == 8 | k == 9 | k == 12 | k == 15 | k == 17 | k == 20 | k == 21 | 
      k == 24 | k == 25 | k == 34 | k == 37 | k == 42 | k == 44 | k == 49 | k == 58 | k == 59 | 
      k == 64 | k == 76 | k == 80 | k == 81 | k == 82 | k == 84 | k == 87 | k == 88 | k == 97 | 
      k == 99 | k == 100 | k == 103 | k == 105 | k == 106 | k == 109) {
    BottomSal_Corr[k] <- may_bottle[may_bottle$Station == k, 2]
  }
}

# add stations not covered by CTD data
BottomSal_Corr[12] <- may_bottle[may_bottle$Station == 12, 2]
BottomSal_Corr[81] <- may_bottle[may_bottle$Station == 81, 2]
