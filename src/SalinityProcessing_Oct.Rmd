...
# salinity check
oct_bottle$CTDsal <- rep(NA, 35)
oct_bottle$offset <- rep(NA, 35)
...
oct_corrected <- as.data.frame(cbind(Station, Cast, CTD_depth, Temp, Press, SeaPress, Salinity_Corr, O2, O2Sat)) %>%
