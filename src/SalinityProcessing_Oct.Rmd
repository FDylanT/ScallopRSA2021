...
summary(lm1) # bottle = 0.98450(CTD) + 0.45644 (bins start @ 2.0m)

comparison_filt <- comparison %>%
  filter(station != 9, station != 64) # remove stations with outlier offsets
...
octCTD$SurfaceSal_Corr <- 0.98450 * octCTD$SurfaceSalinity + 0.45644
#OR
