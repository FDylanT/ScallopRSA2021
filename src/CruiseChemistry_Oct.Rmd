...
#ggplot_build(plot)$layout$panel_scales_x[[1]]$range$range # [31.58157 35.60089]
...
########## pick up here after data processing ##########
...
ggplot() +
  geom_sf(data = GB_sf, fill = "lightblue", colour = "black", size = 0.5) +
  geom_point(data = bottom_sf, aes(x = Long, y = Lat, colour = DIC)) +
...
ggplot() +
  geom_sf(data = GB_sf, fill = "lightgrey", colour = "black", size = 0.5) +
  geom_point(data = bottom_sf, aes(x = Long, y = Lat, colour = DIC), size = 6) +
  #geom_text(data = bottom_sf, aes(x = Long, y = Lat, label = Station),
  #          hjust = -0.05, vjust = 0.05, size = 3) +
  scale_colour_viridis(option = "rocket") +
  #geom_polygon(data = reg, aes(x = long, y = lat, group = group), 
...
```{r}
# Temp
min(bottom_sf_v3$Temp, na.rm = TRUE) # 8.317186
min(surface_sf_v3$Temp, na.rm = TRUE) # 14.26168
max(bottom_sf_v3$Temp, na.rm = TRUE) # 17.79557
max(surface_sf_v3$Temp, na.rm = TRUE) # 20.69855

# Sal
min(bottom_sf_v3$Salinity, na.rm = TRUE) # 32.4402
min(surface_sf_v3$Salinity, na.rm = TRUE) # 31.5816
max(bottom_sf_v3$Salinity, na.rm = TRUE) # 35.6009
max(surface_sf_v3$Salinity, na.rm = TRUE) # 34.0014

# DIC
min(bottom_sf_v3$DIC, na.rm = TRUE) # 1934.6
min(surface_sf_v3$DIC, na.rm = TRUE) # 1931.6
max(bottom_sf_v3$DIC, na.rm = TRUE) # 2154.9
max(surface_sf_v3$DIC, na.rm = TRUE) # 2154.9

# TA
min(bottom_sf_v3$TA, na.rm = TRUE) # 
min(surface_sf_v3$TA, na.rm = TRUE) # 
max(bottom_sf_v3$TA, na.rm = TRUE) # 
max(surface_sf_v3$TA, na.rm = TRUE) # 
```
...
ggplot() +
  ...
  scale_fill_viridis(limits = c(8, 21), option = "inferno") +
...
ggplot() +
  ...
  scale_fill_viridis(limits = c(31, 36)) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
