...
```{r}
oct$Salinity[which(is.na(oct$Salinity))] <- 32.9 # give dummy salinities
### change this^ once we have salinities from Dave

for(i in which(is.na(oct$SeaPressure))) {
    oct$SeaPressure[i] <- oct$Depth[i] # substitude depth for sites without sea pressure
    oct$Pressure[i] <- oct$SeaPressure[i] + 10.1325 # calculate surface pressure from depth
}

octCarb <- carb(15, oct$TA / 10^6, oct$DIC / 10^6, S = oct$Salinity, T = oct$Temp, Patm = oct$Pressure * 0.098692326671601, P = oct$SeaPressure / 10, k1k2 = "l", ks = "d", b = "l10") # flag:15 = ALK & DIC   # k1k2:l = Lueker et al. (2000)   # kf = unspecified b/c low temps   # ks:d = Dickson (1990)   # b:l10 = Lee et al. (2010)
...
#ggplot_build(plot)$layout$panel_scales_x[[1]]$range$range # [31.5816 35.6009]
...
oct %>%
  ...
  scale_x_continuous(limits = c(31.58, 35.61)) +
...
## Oct + May together
(Must run first 6 chunks of CruiseChemistry_May.Rmd file for the below chunk to run)
```{r}
...
```{r}
ggplot(oct, aes(x = Density, y = TA, shape = Cast, group = Station)) +
  geom_point() +
  geom_line() +
  scale_shape_manual(values = c(16, 1)) +
  theme_bw()

ggplot(oct, aes(x = Salinity, y = DIC, shape = Cast, group = Station)) +
  geom_point() +
  geom_line() +
  scale_shape_manual(values = c(16, 1)) +
  theme_bw()

ggplot(oct, aes(x = Salinity, y = TA, shape = Cast, group = Station)) +
  geom_point() +
  geom_line() +
  scale_shape_manual(values = c(16, 1)) +
  theme_bw()
...
station_SPDF <- SpatialPointsDataFrame(coords = oct[ , c("Long", "Lat")],
                                        data = oct[ , c("Long", "Lat", "Station", "Cast", "Depth", "Temp", "Salinity", "Density", "DIC", "TA", "DO", "DO_sat", "AOU", "pH", "fCO2", "OmegaAragonite", "OmegaCalcite", "dDIC", "dTA")],
...
min(surface_sf_v2$Salinity, na.rm = TRUE) # 31.5816
max(bottom_sf_v2$Salinity, na.rm = TRUE) # 35.6009
max(surface_sf_v2$Salinity, na.rm = TRUE) # 34.0014
...
# pH
min(bottom_sf_v2$pH, na.rm = TRUE) # 7.854839
min(surface_sf_v2$pH, na.rm = TRUE) # 7.959847
max(bottom_sf_v2$pH, na.rm = TRUE) # 8.097387
max(surface_sf_v2$pH, na.rm = TRUE) # 8.097527

# OmegaAragonite
min(bottom_sf_v2$OmegaAragonite, na.rm = TRUE) # 1.300235
min(surface_sf_v2$OmegaAragonite, na.rm = TRUE) # 1.946104
max(bottom_sf_v2$OmegaAragonite, na.rm = TRUE) # 2.508693
max(surface_sf_v2$OmegaAragonite, na.rm = TRUE) # 3.059272

# Density
min(bottom_sf_v2$Density, na.rm = TRUE) # 
min(surface_sf_v2$Density, na.rm = TRUE) # 
max(bottom_sf_v2$Density, na.rm = TRUE) # 
max(surface_sf_v2$Density, na.rm = TRUE) # 
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(6, 21), palette = "YlGnBu", aesthetics = c("fill", "colour")) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(31, 36), aesthetics = c("fill", "colour"), name = "Sal") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1930, 2155), option = "rocket", direction = -1, aesthetics = c("fill", "colour")) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(2140, 2355), option = "mako", direction = -1, aesthetics = c("fill", "colour")) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(7.8, 8.25), option = "mako", direction = -1, aesthetics = c("fill", "colour")) +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1.3, 3.1), option = "mako", direction = -1, aesthetics = c("fill", "colour"), name = "OmegaA") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1022, 1027), option = "mako", direction = -1, aesthetics = c("fill", "colour"), name = "Density") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(80, 120), palette = "YlGnBu", aesthetics = c("fill", "colour"), name = "% O2") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-55, 45), palette = "YlGnBu", aesthetics = c("fill", "colour"), name = "AOU") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_distiller(limits = c(-65, 75), palette = "YlGnBu", aesthetics = c("fill", "colour"), name = "AOU") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
...
ggplot() +
  ...
  geom_sf(data = mass_sf, fill = "darkgrey", colour = NA) +
  scale_fill_viridis(limits = c(1.3, 3.1), option = "mako", direction = -1, aesthetics = c("fill", "colour"), name = "OmegaC") +
  coord_sf(xlim = c(371957.88, 746508.34), ylim = c(4428833.79, 4709654.16)) +
