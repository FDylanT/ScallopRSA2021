...
oct1Times_read <- read.csv("./data/oct1Times.txt")
...
oct2Times_read <- read.csv("./data/oct2Times.txt")
...
oct3Times_read <- read.csv("./data/oct3Times.txt")

oct_combined = rbind(oct1, oct2, oct3)
write.csv(oct_combined, "./data/CTD_all_stations_Oct.csv")
```
...
#### Save decimal second timestamps for future use
```{r}
