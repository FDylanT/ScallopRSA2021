...
may1_rsk <- read.rsk("./data/CTD_raw/RSA_20210504_060.rsk")

# Chronological sites 065-113; includes 058-059 + 063-065 + 069-113 (no data from sites 081, 111)
may2_rsk <- read.rsk("./data/CTD_raw/RSA_20210506_113.rsk")
...
write.csv(oct_combined, "./data/CTD_all_stations.csv")
```
