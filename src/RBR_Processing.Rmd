...
may1 <- read.csv("./data/CTD_raw/RSA_20210504_060.csv")

# Chronological sites 065-113; includes 058-059 + 063-065 + 069-113 (no data from sites 081, 111)
may2 <- read.csv("./data/CTD_raw/RSA_20210506_113.csv")

# No data from site 114

may_combined <- rbind(may1, may2)
write.csv(may_combined, "./data/CTD_all_May.csv", row.names = FALSE)

### what can I do about the timestamps?
...
write.csv(oct_combined, "./data/CTD_all_Oct.csv", row.names = FALSE)
```

## Quick load data
```{r}
mayCTD <- read.csv("./data/CTD_all_May.csv")
octCTD <- read.csv("./data/CTD_all_Oct.csv")
```
